...
describe('create https to http data pipeline', () => {
    ...
    it('should create data pipeline with https as source endpoint and http as destination endpoint passing JSON messages', async () => {
        ...
        await populateAndAssertEndpointType(sourcePage.configurationsPage, 'Hypertext Transfer Protocol (HTTP)');
        ...
        await populateAndAssertEndpointType(destinationPage.configurationsPage, 'Hypertext Transfer Protocol (HTTP)');
        ...
        const secure = destinationConfigurations.isSecure;
        browser
            .actions()
            .mouseMove(secure)
            .click();
...
describe('create https to https data pipeline', () => {
    const detailPage: DataPipelineDetailPage = new DataPipelineDetailPage();
    const listPage: DataPipelineListPage = new DataPipelineListPage();
    let randVal: number;
    let beforeListCount: number;
    ...
    it('should create data pipeline with https as source endpoint and https as destination endpoint passing JSON messages', async () => {
        expect(await detailPage.pageTitle.getText()).to.be.eq('Create Data Pipeline');
